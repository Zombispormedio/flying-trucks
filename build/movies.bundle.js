...
var movieProcessor = (0, _processors.createMovieProcessor)();

_rx.Observable.fromPromise(_datasource.store.connectDatabase()).flatMap(function () {
  return movieProcessor.process();
